					...
					<Grid gutter="lg" mt="md">
						...
						<Grid.Col span={{ base: 12, md: 6, lg: 6 }}>
							...
							>
								...
								<Divider my="md" />
								<Text mt="sm" size="sm">
									Consent analytics shows the data of consents
									given by the users on the consent banner
									present on your domain.
								</Text>
								<Text mt="sm" size="sm">
									Opt-in Consent - 16
								</Text>
						...
						<Grid.Col span={{ base: 12, md: 6, lg: 6 }}>
							...
							>
								...
								<Text mt="xs" size="sm">
									Please run a deep scan of your domain to get
